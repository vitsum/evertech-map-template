...
// (GameInitializer.FindObjectOfType<WaterLevel>). GLOBAL namespace (no namespace) — must match
// the game's type identity so the map AssetBundle binds this component in obfuscated release builds.
//
